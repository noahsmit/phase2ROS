...
class SrdfStateToMoveit(EventState):
 	...
 	># joint_values         float[]             Target configuration of the joints.
        ...
        def __init__(self, config_name, move_group = "", action_topic_namespace = "", action_topic = '/move_group', robot_name=""):
                '''
                Constructor
                '''
                ...
                if rospy.has_param(action_topic_namespace + '/robot_description_semantic'):
                        self._srdf_param = rospy.get_param(action_topic_namespace + '/robot_description_semantic')
                else:
